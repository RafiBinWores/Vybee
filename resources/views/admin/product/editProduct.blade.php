...
{{-- page title --}}
@section('page-title')
    Edit Product | Vybee - Admin Dashboard
@endsection
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="form-control" style="display:none;" required>{!! $product->description !!}</textarea>
