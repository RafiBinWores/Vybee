...
$(function () {
    ...
    _functions.initSwiper = function () {
        $(".swiper-container")
            ...
            .each(function () {
                ...
                $t.addClass("swiper-" + index + " initialized").attr(
                    "id",
                    index
                );
                $t.find(">.swiper-pagination").addClass(
                ...
                swipers["swiper-" + index] = new Swiper(".swiper-" + index, {
                        ...
                        ? {
                              767: {
                                  slidesPerView: parseInt(
                                      $t.attr("data-xs-slides"),
                                      10
                                  ),
                              },
                              991: {
                                  slidesPerView: parseInt(
                                      $t.attr("data-sm-slides"),
                                      10
                                  ),
                              },
                              1199: {
                                  slidesPerView: parseInt(
                                      $t.attr("data-md-slides"),
                                      10
                                  ),
                              },
                              1370: {
                                  slidesPerView: parseInt(
                                      $t.attr("data-lt-slides"),
                                      10
                                  ),
                              },
                          }
                        : {},
                    initialSlide: $t.is("[data-ini]")
                        ? parseInt($t.data("ini"), 10)
                        : 0,
                    watchSlidesProgress: true,
                    speed: $t.is("[data-speed]")
                        ? parseInt($t.data("speed"), 10)
                        : 500,
                    ...
                    touchEventsTarget: $t.is("[data-touch]")
                        ? "wrapper"
                        : "container",
                });
    ...
    $(document).on("click", ".open-popup", function (e) {
        ...
        $(
            '.popup-wrapper, .popup-content[data-rel="' +
                $(this).data("rel") +
                '"]'
        ).addClass("active");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $(".popup-wrapper").append(
                    responseObject.addClass("ajax-popup")
                );
